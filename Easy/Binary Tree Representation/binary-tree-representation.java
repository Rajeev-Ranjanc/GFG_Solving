...
class Solution{
    public static void createTree(Node root0, ArrayList<Integer> v ){
       ...
       Node first = new Node(v.get(1));
       Node second = new Node(v.get(2));
       Node third = new Node(v.get(3));
       Node four = new Node(v.get(4));
       Node five = new Node(v.get(5));
       Node six = new Node(v.get(6));
